...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'Z\020.;externalscaler'
  _SCALEDOBJECTREF_SCALERMETADATAENTRY._options = None
  _SCALEDOBJECTREF_SCALERMETADATAENTRY._serialized_options = b'8\001'
